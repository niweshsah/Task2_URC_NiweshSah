Here’s the updated README file including the explanation of the modified BFS algorithm used for the global planner and a comparison with Dijkstra’s algorithm:
